<?php 
    ...
    if(isset($_SESSION['NomeUsuario'])){
        ...
        if($_SESSION['NomeUsuario']->getNomeUsuario() == 'Separacao'){
            $pedidos = $pedidoService->consultarTodosOsPedidosSeparacao();
        } 
        else if($_SESSION['NomeUsuario']->getNomeUsuario() == 'Entrega'){
            $pedidos = $pedidoService->consultarTodosOsPedidosEntrega(); 
        }
        else if($_SESSION['NomeUsuario']->getNomeUsuario() == 'Administrador'){
            $pedidos = $pedidoService->consultarTodosOsPedidos(); 
        }
                    ...
                    <table class="table table-striped">
                        ...
                        <?php for($i=0; $i < count($pedidos); $i++){
                          ...
                          <tr>
                            ...
                            <?php if($pedidos[$i]->getStatus() != "AGUARDANDO PAGAMENTO") :?>
                                <td>
                                <a href="../index.php?Acao=Tramitar&pedido=<?php echo $pedidos[$i]->getId();?>&status=<?php echo $pedidos[$i]->getStatus(); ?>">
